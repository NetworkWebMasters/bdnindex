...
$bdn_maine_authors = array_keys($data['desks']['BDN Maine']);
...
<body>
    <table>
        <thead>
            ...
            $headings = array_keys(reset($data['stories']));
            unset($headings[array_search('word_count', $headings)]);
        ...
        <?php 
            foreach($data['stories'] as $story) {
                ...
                if( !in_array($story['author_id'], $bdn_maine_authors) ) {
                   continue; 
                }

                $story['home_run'] = $story['home_run'] ? "Yes" : "No";
                $story['facebook'] = array_sum($story['facebook']);
